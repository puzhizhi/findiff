...
from findiff import Diff, InvalidGrid, InvalidArraySize, Coef, Spacing
...
class TestDiff(unittest.TestCase):
    ...
    @unittest.skip
    def test_apply_diff_at_single_point_1d(self):
        ...

    @unittest.skip
    def test_apply_diff_at_single_point_2d(self):
        ...
        actual = diff(f, at=(100, 100), spacing=Spacing(h))
        self.assertAlmostEqual(4, actual)

    def test_typo_spacings_raises_exception(self):
        pd = Diff(0)
        with self.assertRaises(ValueError) as e:
            pd(np.ones((10, 10)), spacings=1)
